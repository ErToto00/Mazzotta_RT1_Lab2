...
static const _Info_type_support_symbol_names_t _Info_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, rt1_assignment2, msg, Info)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, rt1_assignment2, msg, Info)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, rt1_assignment2, msg, Info)() {
  return &::rt1_assignment2::msg::rosidl_typesupport_c::Info_message_type_support_handle;
}
