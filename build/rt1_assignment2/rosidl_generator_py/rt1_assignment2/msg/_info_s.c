...
bool rt1_assignment2__msg__info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("rt1_assignment2.msg._info.Info", full_classname_dest, 30) == 0);
  }
  rt1_assignment2__msg__Info * ros_message = _ros_message;
  {  // distance
...
PyObject * rt1_assignment2__msg__info__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("rt1_assignment2.msg._info");
