...
#include "rt1_assignment2/msg/detail/info__rosidl_typesupport_fastrtps_c.h"
...
using _Info__ros_msg_type = rt1_assignment2__msg__Info;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = rt1_assignment2__msg__Info;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const rt1_assignment2__msg__Info * ros_message = static_cast<const rt1_assignment2__msg__Info *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_rt1_assignment2__msg__Info(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  rt1_assignment2__msg__Info * ros_message = static_cast<rt1_assignment2__msg__Info *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_rt1_assignment2__msg__Info(cdr, ros_message);
}

static uint32_t _Info__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_rt1_assignment2__msg__Info(
...
static size_t _Info__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_rt1_assignment2__msg__Info(
